...
const Login:React.FC<LoginProps> = () => {
    return (
        ...
        <h3 className='text-xl font-medium text-white'>Sign in to Leetcode 2.0</h3>
        <div>
        ...
        <div className='text-sm font-medium text-gray-300'>Not Registered? <a href="#" className='text-blue-700 hover:underline'>Create Account</a></div>
        </form>
    )
}
