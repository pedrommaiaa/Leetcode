                ...
                {problems.map((doc, idx) => {
                    ...
                    return (
                        <tr className={`${idx % 2 == 1 ? 'bg-dark-layer-1' : ''}`} key={doc.id}>
                            <th className='px-2 py-4 font-medium whitepsace-nowrap text-dark-green-s'>
                            ...
                            <td className={`px-6 py-4`}>{doc.videoId ? (<AiFillYoutube fontSize={"28"} className='cursor-pointer hover:text-red-500'
